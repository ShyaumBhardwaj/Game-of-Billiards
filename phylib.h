...
typedef struct
{
    double x; // vector in 2 dimensions
    double y;
} phylib_coord;
...
typedef struct
{
    ...
    phylib_coord vel;
    phylib_coord acc;
} phylib_rolling_ball; // Rolling ball

typedef struct
{
    phylib_coord pos; // Hole
} phylib_hole;

typedef struct
{
    double y;
} phylib_hcushion; // Horizontal cushion

typedef struct
{
    double x;
} phylib_vcushion; // Vertical cushion
...
} phylib_untyped; // Parent Class of all objects
